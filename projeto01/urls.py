...
urlpatterns = [
    ...
    path('aluno/add', views.aluno_add, name='aluno_add'),
    path('aluno/edit/<int:aluno_pk>', views.aluno_edit, name='aluno_edit'),
    path('aluno/delete/<int:aluno_pk>', views.aluno_delete, name='aluno_delete'),
